...
public class AWSECommerceService extends Service {
    ...
    public final static QName AWSECommerceServicePortIN = new QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", "AWSECommerceServicePortIN");
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://webservices.amazon.com/AWSECommerceService/2011-08-01/AWSECommerceService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AWSECommerceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://webservices.amazon.com/AWSECommerceService/2011-08-01/AWSECommerceService.wsdl");
        }
        WSDL_LOCATION = url;
    }
