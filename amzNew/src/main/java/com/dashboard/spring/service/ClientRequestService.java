...
public class ClientRequestService {
	...
	Logger logger=Logger.getLogger(ClientRequestService.class);
	
	@Autowired
	private RequestDao requestDao;
	
	public void persistClientReq(HttpServletRequest request){
	    ...
	    clientInfo.setClientIp(clientIpAddr);
	    clientInfo.setClientOs(clientOS);
	    clientInfo.setCreatedBy("SYSTEM");
	    clientInfo.setCreatedDate(new Date());
	    requestDao.persistClientReq(clientInfo);
	}
